...
return packer.startup(function(use)
	...
	use("ItsTerm1n4l/spice.nvim") -- spice theme
	use({ "miikanissi/modus-themes.nvim" })

	use("Yggdroot/indentLine") -- Indent highlighting
	...
	use({ "chrisgrieser/nvim-spider" }) -- move by subwords and skip insignificant punctuation.
